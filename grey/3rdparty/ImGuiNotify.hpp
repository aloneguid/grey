    ...
    inline const char* getIcon() {
        switch(this->type) {
            case ImGuiToastType::None:
                return nullptr;
            case ImGuiToastType::Success:
                return ICON_MD_CHECK; // Font Awesome 6
            case ImGuiToastType::Warning:
                return ICON_MD_WARNING; // Font Awesome 6
            case ImGuiToastType::Error:
                return ICON_MD_ERROR; // Font Awesome 6
            case ImGuiToastType::Info:
                return ICON_MD_INFO; // Font Awesome 6
            default:
                return nullptr;
        }
    }
...
#elif defined(__linux__) || defined(__EMSCRIPTEN__) || defined(__APPLE__)
