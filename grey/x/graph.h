...
namespace grey::x {
    struct graph_node {
        int id;
        ImVec2 pos;
        rgb_colour fill_colour{0.2f, 0.6f, 0.9f, 1.0f};
        rgb_colour text_colour{1.0f, 1.0f, 1.0f, 1.0f};
        rgb_colour border_colour{0.3f, 0.7f, 1.0f, 1.0f};
        float radius{25.0f};
    };
    ...
    struct graph_edge {
        int from_node_id;
        int to_node_id;
        rgb_colour colour{0.8f, 0.8f, 0.8f, 1.0f};
    };
